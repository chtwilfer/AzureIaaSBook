...
.SYNOPSIS
This script will deploy a Windows VM into Azure on a managed disk.
...
is being targeted. Additionally, Azure PowerShell 3.5 or higher is required in order to work with managed disks.
...
.NOTES
Filename:   deploy-unique-vm-to-azure-managed-disk.ps1
Author:     Ryan Irujo (https://github.com/starkfell)
Language:   PowerShell 5.0

Syntax:           ./deploy-unique-vm-to-azure-managed-disk.ps1 `
...
Example:          ./deploy-unique-vm-to-azure-managed-disk.ps1 `
