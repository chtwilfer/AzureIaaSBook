...
.NOTES
Filename:   deploy-unique-vm-to-azure-unmanaged-disk.ps1
Author:     Ryan Irujo (https://github.com/starkfell)
Language:   PowerShell 5.0

Syntax:           ./deploy-unique-vm-to-azure-unmanaged-disk.ps1 `
...
Example:          ./deploy-unique-vm-to-azure-unmanaged-disk.ps1 `
